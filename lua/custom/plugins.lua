...
return packer.startup(function(use)
	...
	-- use { 'nvim-treesitter/nvim-treesitter', run = ":TSUpdate" } -- syntax highlight. The failure on first installation is as expected. -- Disable for an error since Dec 1st 2022.
